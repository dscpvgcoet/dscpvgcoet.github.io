...
class OldTeam extends React.Component {
  constructor(props) {
    super(props);
  ...
  renderCoreTeam = (start, end) => {
    const { prev_core } = teamInfo;
    return prev_core.slice(start, end).map((member) => {
      return member ? (
  ...
  renderCompleteTeam = (start, end) => {
    const { prev_complete } = teamInfo;
    return prev_complete.slice(start, end).map((member) => {
      return member ? (
        <div className="core-member-box">
      ...
      <div>
        ...
        >
          <div className="left-side">
            <p className="h3 darkText">Team 21-22</p>
