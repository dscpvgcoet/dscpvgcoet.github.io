...
const featuresEventsInfo = [
  {
    ...
    description:
      "Over 100 students were mentored by coding experts over 2 months",
    image: codebuddy,
  },
  {
    ...
    return (
      <div className="main-container">
        ...
        <div className="home-main-content">
          <div className="home-main-content-inner">
            <div className="home-main-content-text">
              ...
              >
                We at GDSC PVGCOET hope to empower young developers discover{" "}
              </p>
          ...
          <div className="verbose-container">
            <div className="verbose-upper">
              <div className="verbose-heading">
                ...
                <a
                  href="https://open.spotify.com/show/2rx52wlDkwR9DlAXq83IYH?si=D8Dn8w8NTEW1X35mD7NaIw"
                  target="_blank"
                >
                  <div className="spotify-button">
                    ...
                    <div>
                      ...
                      <p className="h5" style={{ color: "#11C30E" }}>
                        Spotify
                      </p>
                    </div>
                  </div>
              ...
              <div className="verbose-featured">
                <iframe
                  src="https://open.spotify.com/embed-podcast/episode/0WDHQzIXLnx97XPbyQ91PZ"
                  width="100%"
                  height="100%"
                  frameborder="0"
                  allowtransparency="true"
            ...
            <div className="verbose-lower">
              {verboseLogInfo.map(
                ({ title, speakers, episode, link, image }, index) => {
                  return (
                    <RenderSpotifyCard
                      title={title}
                      speakers={speakers}
          ...
          <div className="infographic-container">
            ...
            >
              <p className="h5 tanText" style={{ color: "#fff" }}>
                <span style={{ fontSize: 40 }}>16</span>
                <br />
                committee members
              </p>
            </infograph>
        ...
        <p
          ...
          style={{ marginTop: 20 }}
        >
          Join GDSC PVGCOET today to be a part of this! &#128512;
        </p>
